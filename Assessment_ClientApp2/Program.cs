...
namespace Assessment_ClientApp2
{
    ...
    class Program
    {
        ...
        static List<Monster> InitializeMonsterList()
        {
            ...
            List<Monster> monsters = new List<Monster>()
            {
                ...
                new Monster()
                {
                    ...
                    Tribe = Monster.TribeLocation.land,
                    Active = true
                },
                ...
                new Monster()
                {
                    ...
                    Tribe = Monster.TribeLocation.ocean,
                    Active = false
                },
                ...
                new Monster()
                {
                    ...
                    Tribe = Monster.TribeLocation.sky,
                    Active = true
                },
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            Console.Write("\tTribe: ");
            Enum.TryParse(Console.ReadLine(), out Monster.TribeLocation tribe) ;
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            if (userResponse != "")
            {
                Enum.TryParse(userResponse, out Monster.TribeLocation tribe);
                selectedMonster.Tribe = tribe;
            }

            Console.Write($"\tCurrent Status: {selectedMonster.Active} New Satus: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
        ...
        static List<Monster> ReadFromDataFile()
        {
            ...
            foreach (string monsterString in monstersString)
            {
                ...
                Enum.TryParse(monsterProperties[3], out Monster.TribeLocation tribe);
                newMonster.Tribe = tribe;
