...
namespace Assessment_ClientApp2
{
    ...
    public class Monster
    {
        ...
        public Monster(string name, int age, EmotionalState attitude, TribeLocation tribe )
        {
            _name = name;
            _age = age;
            _attitude = attitude;
